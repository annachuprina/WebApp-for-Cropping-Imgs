This web application is created to crop paired photos(such as the eyes of different people ) to get a match in size. It can be used when creating creative invitations to events
